...
from transformers import (TrainerCallback, BertForSequenceClassification,
...
def save_results(config, label_encoder, predictions, predictions_climate, test_df):
    ...
    outputs_dict = {}
    outputs_dict['note'] = 'bert_model_with_attention_check_cbr_different_features_for_retrieval_baseline'
